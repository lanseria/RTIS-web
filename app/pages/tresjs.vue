...
/* Add styles for the tile labels */
.tile-label {
  color: white;
  font-family: sans-serif;
  /* Adjust font size as needed for visibility */
  font-size: 5px;
  /* Center the text (optional, but usually looks better) */
  text-align: center;
  /* Add a slight background for readability against different tile colors */
  /* background-color: rgba(0, 0, 0, 0.3); */
  /* padding: 0px 2px; */
  /* border-radius: 2px; */

  /* Prevent the label from blocking mouse events (like clicks) on the tile underneath */
  pointer-events: none;
  user-select: none; /* Prevent text selection */

  /* Adjust positioning if needed - sometimes needs a slight Y offset */
